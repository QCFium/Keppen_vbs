...
On Error Resume Next
	...
	For Each objComputer in colComputers
		...
		End If
		strFull =  "Windows " & "(" & szTmp & ") "
		strRet = strRet & "SP" & objComputer.ServicePackMajorVersion & "." & objComputer.ServicePackMinorVersion
		strFull = strFull & "SP" & objComputer.ServicePackMajorVersion & "." & objComputer.ServicePackMinorVersion
		strOSAr = ""
		...
		strFull = strFull & " " & strOSAr
	Next
	strRet = Replace(strRet,"ビット","bit")
	strFull = Replace(strFull,"ビット","bit")
	GetOSType = strRet
	GetOSTypeF = strFull
	Err.Clear
	On Error goto 0
...
log = log & "OS:" & GetOSType & Chr(13) & "OS Full:" & GetOSTypeF & Chr(13) & "Memory:" & GetMemory() & Chr(13)
